 ...
 */
final class Version20210412200009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test_jednatelu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, result INTEGER NOT NULL, netypycky_vek_jednatele INTEGER DEFAULT NULL, insolvence INTEGER DEFAULT NULL, bydleni_mimo_eu INTEGER DEFAULT NULL, pocet_jednatelu INTEGER DEFAULT NULL, pocet_jinych_subjektu INTEGER DEFAULT NULL, pocet_jinych_subjektu_v_likvidaci INTEGER DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_560581FD2E9F375 ON firm (test_subjektu_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_560581FD77BD680F ON firm (test_domeny_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__test_jednatelu AS SELECT id, pocet_jednatelu, pocet_jinych_subjektu, pocet_jinych_subjektu_v_likvidaci, netypycky_vek_jednatele, insolvence, bydleni_mimo_eu, result FROM test_jednatelu');
        $this->addSql('DROP TABLE test_jednatelu');
        $this->addSql('CREATE TABLE test_jednatelu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, netypycky_vek_jednatele INTEGER DEFAULT NULL, insolvence INTEGER DEFAULT NULL, bydleni_mimo_eu INTEGER DEFAULT NULL, result INTEGER NOT NULL, pocet_jednatelu INTEGER NOT NULL, pocet_jinych_subjektu INTEGER NOT NULL, pocet_jinych_subjektu_v_likvidaci INTEGER NOT NULL)');
        $this->addSql('INSERT INTO test_jednatelu (id, pocet_jednatelu, pocet_jinych_subjektu, pocet_jinych_subjektu_v_likvidaci, netypycky_vek_jednatele, insolvence, bydleni_mimo_eu, result) SELECT id, pocet_jednatelu, pocet_jinych_subjektu, pocet_jinych_subjektu_v_likvidaci, netypycky_vek_jednatele, insolvence, bydleni_mimo_eu, result FROM __temp__test_jednatelu');
        $this->addSql('DROP TABLE __temp__test_jednatelu');
    }
}
