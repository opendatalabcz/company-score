 ...
 */
final class Version20210412193422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__test_domeny AS SELECT id, pocet_let_v_provozu, posledni_modifikace, result, status FROM test_domeny');
        $this->addSql('DROP TABLE test_domeny');
        $this->addSql('CREATE TABLE test_domeny (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, result INTEGER NOT NULL, pocet_let_v_provozu INTEGER DEFAULT NULL, posledni_modifikace INTEGER DEFAULT NULL, status INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO test_domeny (id, pocet_let_v_provozu, posledni_modifikace, result, status) SELECT id, pocet_let_v_provozu, posledni_modifikace, result, status FROM __temp__test_domeny');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE test_domeny');
        $this->addSql('CREATE TABLE test_domeny (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, result INTEGER NOT NULL, status INTEGER NOT NULL, pocet_let_v_provozu INTEGER NOT NULL, posledni_modifikace INTEGER NOT NULL)');
