 ...
 */
final class Version20210411190503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__firm AS SELECT id, name, ico, sidlo, result FROM firm');
        ...
        $this->addSql('INSERT INTO firm (id, name, ico, sidlo, result) SELECT id, name, ico, sidlo, result FROM __temp__firm');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__firm AS SELECT id, name, ico, sidlo, result FROM firm');
        $this->addSql('DROP TABLE firm');
        $this->addSql('CREATE TABLE firm (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, ico VARCHAR(8) NOT NULL, sidlo VARCHAR(255) NOT NULL, result INTEGER NOT NULL, test_jednatelu_id_id INTEGER DEFAULT NULL, bonusovy_test_id_id INTEGER DEFAULT NULL, test_subjektu_id_id INTEGER DEFAULT NULL, test_domeny_id_id INTEGER DEFAULT NULL, zakladni_test_id_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO firm (id, name, ico, sidlo, result) SELECT id, name, ico, sidlo, result FROM __temp__firm');
        $this->addSql('DROP TABLE __temp__firm');
