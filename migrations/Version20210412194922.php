 ...
 */
final class Version20210412194922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test_subjektu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pocet_zamestnancu INTEGER DEFAULT NULL, pocet_let_na_trhu INTEGER NOT NULL, jine_subjekty_na_sidle INTEGER DEFAULT NULL, result INTEGER NOT NULL, nespolehlivy_platce INTEGER DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__test_subjektu AS SELECT id, pocet_zamestnancu, pocet_let_na_trhu, nespolehlivy_platce, jine_subjekty_na_sidle, result FROM test_subjektu');
        $this->addSql('DROP TABLE test_subjektu');
        $this->addSql('CREATE TABLE test_subjektu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pocet_zamestnancu INTEGER DEFAULT NULL, pocet_let_na_trhu INTEGER NOT NULL, jine_subjekty_na_sidle INTEGER DEFAULT NULL, result INTEGER NOT NULL, nespolehlivy_platce VARCHAR(3) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO test_subjektu (id, pocet_zamestnancu, pocet_let_na_trhu, nespolehlivy_platce, jine_subjekty_na_sidle, result) SELECT id, pocet_zamestnancu, pocet_let_na_trhu, nespolehlivy_platce, jine_subjekty_na_sidle, result FROM __temp__test_subjektu');
        $this->addSql('DROP TABLE __temp__test_subjektu');
    }
}
